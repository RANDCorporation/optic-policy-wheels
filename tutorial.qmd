...
**data** 
a dataframe — this should be a wide dataset; rows are states, and columns contain the date on which each policy was implemented. Dates can be in the form of `"1/15/2015"`, `"2015-01-15"`, `"2015"`, or `"January 15, 2015"`— only the year will be kept.

**policies** 
a character vector containing the names of the policy variables you would like contained in your policy wheels.

**state_var** 
a string — the name of the variable identifying each state by its two-letter abbreviation (all caps).
...
**plot_colors** 
character vector containing the names of the colors assigned to each policy.
...
* `plot_width` and `plot_height`: These control the dimensions of the plot output and will need to be adjusted according to your needs.
