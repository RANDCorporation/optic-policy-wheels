...
This [code repository](https://github.com/RANDCorporation/optic-policy-wheels) and [tutorial](tutorial.qmd) allow users to create OPTIC style policy wheel data visualizations that illustrate the timeline over which state policies are implemented concurrently using R.

## Usage

See the [tutorial](tutorial.qmd).
