...
This [code repository](https://github.com/RANDCorporation/optic-policy-wheels) (and its [tutorial](tutorial.qmd)) allows users to create Opioid Policy Tools and Information Center (OPTIC)-style policy wheel data visualizations (like the one below) that illustrate the timeline over which state policies are implemented:
...
Drug Abuse grant (P50DA046351) to RAND and carried out
within the Access and Delivery Program in RAND Health Care.

RAND Health Care, a division of RAND, promotes healthier
...
For questions related to this repository, contact [Beth Ann Griffin](bethg@rand.org) or [Joshua Eagan](jeagan@rand.org).

## License

Copyright (C) 2025 by The RAND Corporation. Released as open-source software under [GPL-3.0 license](https://www.r-project.org/Licenses/GPL-3).
